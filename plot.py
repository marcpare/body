...
# Unroll Stronglifts data, merge with Strong data

# Mark computed 1RM in all lift data

# Add dummy min begin and max end date to body composition and lift data
